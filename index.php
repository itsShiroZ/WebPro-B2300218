...
$resultanime = $conn->query("SELECT * FROM content WHERE type = 'anime' AND (title = 'dummy' OR title LIKE '%$querydetail%') ");
...
//film
$resultfilm = $conn->query("SELECT * FROM content WHERE type = 'film' AND (title = 'dummy' OR title LIKE '%$querydetail%') ");
...
//k drama
$resultkdrama = $conn->query("SELECT * FROM content WHERE type = 'kdrama' AND (title = 'dummy' OR title LIKE '%$querydetail%') ");
...
<body>
        ...
        <div class="navdiv">
            <div class="logo">
                ...
                <form action='' method='post'>
                    <input type="text" placeholder="Search" id="mysearch" name="mysearch">
    ...
    <form class="query" method="post" action="">
        <button type="submit" name="mysearch">Clear Query</button>
    </form>
    <style>
        .query{
            margin-left: 6vw;
